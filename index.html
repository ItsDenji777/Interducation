...
<head>
    ...
    <title>ItsDenji777 - Website</title>
            ...
            <div class="container">
                <div class="site-header-inner">
                    <div class="brand header-brand">
                        <h1 class="m-0">
							<a>
								<img class="header-logo-image" height="90" width="90" src="dist/images/logo.svg" alt="Logo">
                            </a>
                        </h1>
                    </div>
                </div>
            ...
            <section class="hero">
                <div class="container">
                    <div class="hero-inner">
						<div class="hero-copy">
	                        <h1 class="hero-title mt-0">Hello There!</h1>
	                        <p class="hero-paragraph">Im a newbie programmer,and im trying to fit into the Developers Universe! The journy is Just Smooth Sailing ^-^...i lied its bumpy like a desert.</p>
	                        <div class="hero-cta"><a class="button button-primary" href="https://github.com/ItsDenji777">My GitHub</a><a class="button" href="#sitefooter">Get in touch</a></div>
						</div>
                        ...
                        <div class="features-wrap">
                            <div class="feature text-center is-revealing">
                                <div class="feature-inner">
                                    ...
                                    <p class="text-sm mb-0">At this moment im more focusing my Programming Career on Python,This is the Language that im most fluent in among the ones im learning!</p>
                                </div>
                            </div>
							<div class="feature text-center is-revealing">
                                <div class="feature-inner">
                                    ...
                                    <p class="text-sm mb-0">Haven't learned much of it(cause its probably i just started a month ago) but i can do some stuff with it :)</p>
                                </div>
                            </div>
                            <div class="feature text-center is-revealing">
                                <div class="feature-inner">
                                    <div class="feature-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="99" height="99" viewBox="0 0 256 288">
                                    ...
                                    <p class="text-sm mb-0">Wasn't hard to learn,i have done some pretty great work with it.and im fluent(enough) in C++.</p>
                                </div>
                            </div>
                            <div class="feature text-center is-revealing">
                                <div class="feature-inner">
                                    <div class="feature-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="90.78" height="128" viewBox="0 0 256 361">
                                    ...
                                    <h4 class="feature-title mt-24">HTML&CSS</h4>
                                    <p class="text-sm mb-0">Was the first thing i learned! and the least thing i used,but it comes in handy so much.</p>
                                </div>
                            </div>
							<div class="feature text-center is-revealing">
                                <div class="feature-inner">
                                    <div class="feature-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="128" height="48" viewBox="0 0 512 192">
                                    ...
                                    <h4 class="feature-title mt-24">Go</h4>
                                    <p class="text-sm mb-0">Just did it so i can write a few Projects,but now i live with knowing how to code in "Go".</p>
                                </div>
                            </div>
                            <div class="feature text-center is-revealing">
                                <div class="feature-inner">
                                    <div class="feature-icon">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="64" height="86.5" viewBox="0 0 256 346">
                                    ...
                                    <p class="text-sm mb-0">The Best one out of the 6 Languages i know,Not gonna lie i love it! but it took me a lot of affort to learn it.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <ul class="footer-social-links list-reset">
                        ...
                        <li>
                            <a href="mailto:DenjisWorkspace@Gmail.com">
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="0.98em" height="1em" viewBox="0 0 256 262"><path fill="#4285f4" d="M255.878 133.451c0-10.734-.871-18.567-2.756-26.69H130.55v48.448h71.947c-1.45 12.04-9.283 30.172-26.69 42.356l-.244 1.622l38.755 30.023l2.685.268c24.659-22.774 38.875-56.282 38.875-96.027"/><path fill="#4285f4" d="M130.55 261.1c35.248 0 64.839-11.605 86.453-31.622l-41.196-31.913c-11.024 7.688-25.82 13.055-45.257 13.055c-34.523 0-63.824-22.773-74.269-54.25l-1.531.13l-40.298 31.187l-.527 1.465C35.393 231.798 79.49 261.1 130.55 261.1"/><path fill="#4285f4" d="M56.281 156.37c-2.756-8.123-4.351-16.827-4.351-25.82c0-8.994 1.595-17.697 4.206-25.82l-.073-1.73L15.26 71.312l-1.335.635C5.077 89.644 0 109.517 0 130.55s5.077 40.905 13.925 58.602z"/><path fill="#4285f4" d="M130.55 50.479c24.514 0 41.05 10.589 50.479 19.438l36.844-35.974C195.245 12.91 165.798 0 130.55 0C79.49 0 35.393 29.301 13.925 71.947l42.211 32.783c10.59-31.477 39.891-54.251 74.414-54.251"/></svg>
                                    
                                </svg>
                            </a>
                        </li>
                    </ul>
                    <div class="footer-copyright">&copy; ItsDenji777, an independent developer</div>
                </div>
            </div>
        </footer>
    </div>
